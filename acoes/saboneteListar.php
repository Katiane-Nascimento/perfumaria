...
function imprimeMensagem () {
    ...
    if ($nome == "existe"){
        return "<h4 class='erro'>Erro! Não foi possível editar pois esse nome já está cadastrado!</h4><br><br>";
    }
}

$saboneteControl = new SaboneteControl($db);
$resultados = $saboneteControl->listarObj(); //chama a função responsável por buscar os valores no banco de dados e transformar em objetos

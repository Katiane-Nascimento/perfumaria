...
$resultados = $relFornecedorProduto->pesquisar($pesquisa); //chama a função responsável por pesquisar as linha que possuem a string digitada na marca do produto
